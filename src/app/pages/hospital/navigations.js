export const hospital_navigations = [
  ...
  { name: 'Users', path: '/netcare/hospital/user', icon: 'group' },

  { label: 'SERVICE PROVIDERS', type: 'label' },
  { name: 'Service Providers', path: '/netcare/hospital/service-provider', icon: 'dashboard' },
];
